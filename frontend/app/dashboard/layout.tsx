...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex font-sans text-slate-900 relative overflow-hidden bg-slate-50">
      ...
      <motion.aside
        animate={{
          width: isDesktopExpanded ? 280 : 88
        }}
      ...
      >
        <div className="h-full flex flex-col relative">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <NavItem href="/profile" icon={User} label="Profile" expanded={isDesktopExpanded} />
          </nav>
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <div className="hidden lg:block">
              <UserButton
                ...
                appearance={{
                  elements: {
                    userButtonAvatarBox: "h-10 w-10 border-2 border-white shadow-sm hover:scale-105 transition-transform"
                  }
                }}
              />
            </div>
