    ...
    >
      ...
      <div className="container mx-auto max-w-[95%] xl:max-w-[1600px] relative z-10 h-full flex items-center">
        ...
        <motion.div
          ...
          className="neo-glass rounded-[2.5rem] p-6 md:p-12 lg:p-16 relative overflow-hidden shadow-2xl border border-slate-200 w-full"
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
            ...
            <motion.div style={{ y: yText }} className="text-left space-y-6 lg:space-y-8 order-2 lg:order-1">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/70 border border-white/80 text-slate-800 backdrop-blur-md shadow-sm"
              >
            ...
            <div className="relative h-[400px] lg:h-[600px] w-full perspective-1000 flex items-center justify-center order-1 lg:order-2">
              ...
              {/* DNA Helix - Main Focus */}
              <div className="absolute inset-0 z-0 flex items-center justify-center opacity-90 scale-110">
                <DNAHelix />
              </div>
