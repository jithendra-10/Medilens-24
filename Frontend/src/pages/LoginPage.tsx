  ...
  return (
    ...
    >
      <div className="w-full">
        <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-8 tracking-tight">Log In</h2>

        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <button
            type="button"
            onClick={() => alert("Google Login integration is coming soon!")}
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-2.5 px-4 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors shadow-sm"
          >
        ...
        <div className="relative mb-8 text-center">
          ...
          <span className="relative bg-white px-3 text-sm text-slate-500 font-medium tracking-widest">-OR-</span>
        </div>
